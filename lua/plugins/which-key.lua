return {
    ...
    --
    {
        ...
        config = function(_, opts)
            ...
            local g_opts = { mode = { "n", "v" }, prefix = "g" }

            local C_g_opts = { mode = { "n", "v" }, prefix = "" }
            local normal_keymap = {
            ...
            local normal_keymap = {
                ...
                qq = { ":q!<cr>", "Quit without saving" },
                Q = { ":qa!<cr>", "Quit all windows without saving" },
                L = { "<cmd>Lazy<cr>", "open lazy.nvim plugins window" },

                M = { "<cmd>Mason<cr>", "open Mason.nvim plugins window" },
                O = { "<cmd>AerialToggle<cr>", "Toggle code outline window" }, -- aerial.nvim plugin   --<leader>O  AerialToggle  --{  previous function  --} next function
                b = {
                    name = "Buffer/Bot",
                ...
                f = {
                    ...
                    --BUG: 当唤起Telescope其他命令之后，在使用快捷键唤起Telescope buffers时，会重复唤起之前的窗口，而不是唤起buffers
                    b = { ": Telescope buffers<cr>", "Switch buffers" },

                    h = { ":Telescope frecency<cr>", "Most (f)recently used files" },
                    ...
                    t = { "<cmd>lua require'telescope'.extensions.live_grep_args.live_grep_args()<cr>",
                        "Grep text with args" },
                ...
                g = {
                    ...
                    e = {
                        ...
                        L = { "<cmd>Telescope advanced_git_search search_log_content_file<cr>",
                            "Search in file log content" },
                        d = { "<cmd>lua require 'gitsigns'.diffthis('~')<cr>", "Diff This ~" },
